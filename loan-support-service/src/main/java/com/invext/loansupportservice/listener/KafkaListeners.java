package com.invext.loansupportservice.listener;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.invext.loansupportservice.dto.AttendantDTO;
import com.invext.loansupportservice.dto.TicketDTO;
import com.invext.loansupportservice.model.CustomerRequest;
...
public class KafkaListeners {
    ...
    private void getAvailableAttendants() {
        String url = "http://localhost:8080/api/v1/attendants/loan";
    ...
    @KafkaListener(topics = "loan-support", groupId = "loan")
