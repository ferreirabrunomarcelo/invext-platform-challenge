package com.invext.cardsupportservice.listener;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.invext.cardsupportservice.dto.AttendantDTO;
import com.invext.cardsupportservice.dto.TicketDTO;
import com.invext.cardsupportservice.model.CustomerRequest;
...
public class KafkaListeners {
    ...
    private void getAvailableAttendants() {
        String url = "http://localhost:8080/api/v1/attendants/card";
    ...
    @KafkaListener(topics = "card-support", groupId = "card")
